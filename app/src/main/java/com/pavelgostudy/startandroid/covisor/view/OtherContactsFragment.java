...
public class OtherContactsFragment extends Fragment {
    ...
    private OtherContactsViewModel mViewModel;

    public static OtherContactsFragment newInstance() {
        return new OtherContactsFragment();
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(OtherContactsViewModel.class);
